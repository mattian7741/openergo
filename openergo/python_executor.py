...
class PythonExecutor(Executor):
    ...
    def __init__(self, function: Union[Callable[..., Any], str], config: Dict[str, Any]) -> None:
        ...
        if isinstance(function, str):
            ...
            raise TypeError("function must be a callable or a fully qualified string path")
